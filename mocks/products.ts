...
export const products: Product[] = [
  ...
  // CARTRIDGE PENS PRODUCTS (Category '20') - 5 products
  {
    id: '2000',
    name: 'Elite USB-C Cartridge Pen',
    category: '20',
    thc: 78,
    cbd: 0,
    price: 15,
    ...
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1561041695-d2faaf38e42a?q=80&w=1000',
    description: "Our flagship USB-C cartridge pen features premium build quality with fast charging technology. Reaches full charge in 20 minutes and provides 200+ draws. Includes premium carrying case and USB-C cable.",
  ...
  },
  {
    ...
    rating: 4.6,
    image: 'https://images.unsplash.com/photo-1563298723-dcfebaa392e3?q=80&w=1000',
    description: "Ultra-portable USB-C cartridge pen perfect for discreet use. Features rapid 15-minute charging and sleek aluminum design. Fits easily in your pocket or purse.",
    effects: ['Discreet', 'Portable', 'Quick'],
    featured: true,
  },
  {
    id: '2002',
    name: 'Pro USB-C Cartridge Pen',
    category: '20',
    thc: 80,
    cbd: 0,
    price: 20,
    ...
    rating: 4.7,
    image: 'https://images.unsplash.com/photo-1581101767113-7b6e54c1b7c0?q=80&w=1000',
    description: "Professional-grade USB-C cartridge pen with temperature control and LED battery indicator. Features ceramic heating element for pure flavor and consistent vapor production.",
  ...
  },
  {
    ...
    rating: 4.5,
    image: 'https://images.unsplash.com/photo-1533423996279-f9938f12a0ce?q=80&w=1000',
    description: "Revolutionary 10-minute fast charging USB-C cartridge pen with wireless charging capability. Features smart chip technology for optimal performance and safety.",
    effects: ['Fast', 'Smart', 'Wireless'],
    featured: true,
  },
  {
    id: '2004',
    name: 'CBD USB-C Cartridge Pen',
    category: '20',
    thc: 10,
    cbd: 70,
    price: 15,
    ...
    rating: 4.4,
    image: 'https://images.unsplash.com/photo-1561041695-d2faaf38e42a?q=80&w=1000',
    description: "CBD-focused USB-C cartridge pen designed for wellness and relaxation. Features precise dosing technology and USB-C fast charging for consistent therapeutic benefits.",
