...
export const products: Product[] = [
  ...
  // PRE-ROLL PRODUCTS (Category '2') - 5 products
  {
    ...
    description: "Our classic pre-rolled joint is perfect for on-the-go enjoyment. Each joint contains premium flower that has been ground to perfection and rolled with care.",
    effects: ['Relaxed', 'Happy', 'Euphoric'],
    featured: true,
  },
  {
  ...
  {
    id: '403',
    name: 'USB-C Rechargeable Vape Pen',
    category: '4',
    thc: 75,
    cbd: 0,
    price: 35,
    ...
    description: "This premium rechargeable vape pen features USB-C fast charging technology and a sleek design. The 0.5g cartridge provides smooth, consistent vapor with every draw. Includes USB-C charging cable and reaches full charge in just 30 minutes.",
    effects: ['Relaxed', 'Happy', 'Euphoric'],
    featured: true,
  },
  {
  ...
  // VAPE PENS PRODUCTS (Category '20') - 5 products with updated prices
  {
    id: '2000',
    name: 'Elite USB-C Vape Pen',
    category: '20',
    thc: 78,
    cbd: 0,
    price: 15,
    volume: '1g',
    image: 'https://images.unsplash.com/photo-1561041695-d2faaf38e42a?q=80&w=1000',
    description: "Our flagship USB-C vape pen features premium build quality with fast charging technology. Reaches full charge in 20 minutes and provides 200+ draws. Includes premium carrying case and USB-C cable.",
    effects: ['Premium', 'Smooth', 'Long-lasting'],
    featured: true,
  },
  {
    id: '2001',
    name: 'Compact USB-C Pen',
    category: '20',
    thc: 72,
    cbd: 0,
    price: 20,
    volume: '0.5g',
    image: 'https://images.unsplash.com/photo-1563298723-dcfebaa392e3?q=80&w=1000',
    description: "Ultra-portable USB-C vape pen perfect for discreet use. Features rapid 15-minute charging and sleek aluminum design. Fits easily in your pocket or purse.",
    effects: ['Discreet', 'Portable', 'Quick'],
    featured: true,
  },
  {
    id: '2002',
    name: 'Pro USB-C Vape Pen',
    category: '20',
    thc: 80,
    cbd: 0,
    price: 20,
    volume: '1g',
    image: 'https://images.unsplash.com/photo-1581101767113-7b6e54c1b7c0?q=80&w=1000',
    description: "Professional-grade USB-C vape pen with temperature control and LED battery indicator. Features ceramic heating element for pure flavor and consistent vapor production.",
    effects: ['Professional', 'Controlled', 'Pure'],
    featured: false,
  },
  {
    id: '2003',
    name: 'Fast Charge USB-C Pen',
    category: '20',
    thc: 75,
    cbd: 0,
    price: 12,
    volume: '0.8g',
    image: 'https://images.unsplash.com/photo-1533423996279-f9938f12a0ce?q=80&w=1000',
    description: "Revolutionary 10-minute fast charging USB-C vape pen with wireless charging capability. Features smart chip technology for optimal performance and safety.",
    effects: ['Fast', 'Smart', 'Wireless'],
    featured: true,
  },
  {
    id: '2004',
    name: 'CBD USB-C Vape Pen',
    category: '20',
    thc: 10,
    cbd: 70,
    price: 15,
    volume: '1g',
    image: 'https://images.unsplash.com/photo-1561041695-d2faaf38e42a?q=80&w=1000',
    description: "CBD-focused USB-C vape pen designed for wellness and relaxation. Features precise dosing technology and USB-C fast charging for consistent therapeutic benefits.",
    effects: ['Therapeutic', 'Wellness', 'Precise'],
    featured: false,
  },
];
